...
4. Score records with `references/opportunity-scoring.md`.
5. Group records into audience themes, objection patterns, and creator segments.
6. Produce a short social growth brief with evidence and next actions.
